...
ns = {}
exec(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'all_holes_data_v3_65.py')).read(), ns)
HOLES = ns['HOLES']
...
pdf_path = '/mnt/user-data/outputs/AQ_Sector_Maps_v3.65_all18.pdf'
with PdfPages(pdf_path) as pdf:
    fig = plt.figure(figsize=(11, 8.5))
    fig.text(0.5, 0.62, 'Oberlin Golf Club', ha='center', fontsize=28, fontweight='bold')
    fig.text(0.5, 0.53, 'AQ Sector Maps — data v3.65', ha='center', fontsize=17, color='#555')
